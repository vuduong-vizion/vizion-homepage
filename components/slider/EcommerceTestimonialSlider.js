                ...
                <SwiperSlide>
                    <div className="item">
                        ...
                        <div className="meta">
                            ...
                            <div className="logo"><img src="/assets/images/client-01.webp" alt="Logo" /></div>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="item">
                        ...
                        <div className="meta">
                            ...
                            <div className="logo"><img src="/assets/images/client-02.webp" alt="Logo" /></div>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="item">
                        ...
                        <div className="meta">
                            ...
                            <div className="logo"><img src="/assets/images/client-03.webp" alt="Logo" /></div>
                        </div>
                    </div>
                </SwiperSlide>
            </Swiper>
