                ...
                {!blogStyle == 'style-card' && (
                  <>
                    <div className="entry-description">
                      <p>
                        Gated content can be an incredible way to monetize your work as a creator. So, what is gated
                        content you may ask? It’s exclusive content that is behind a “barrier” - allowing your fans to
                        either ...
                      </p>
                    </div>
            ...
            <article className={`post post-masonry format-quote ${blogStyle ? blogStyle : ''}`}>
              ...
              <div className="entry-content">
                ...
                <div className="entry-title">
                  <h3>
                    <Link href="/" title="Behind the website of a renowned athlete">
                      Behind the website of a renowned athlete
                    </Link>
                  </h3>
                </div>
                {!blogStyle == 'style-card' && (
