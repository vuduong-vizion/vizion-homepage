export default function Shopify_App_Section2() {
    return (
        <>
                ...
                <div className="container">
                    <div className="heading align-center">
                        <h2 className="heading-title size-l">
                            Why over 1,200 stores use our app
                        </h2>
                    </div>
                                ...
                                <div className="icon-box">
                                    <div className="inner">
                                        ...
                                        <div className="content pdr50">
                                            <h3 className="title">Easy &amp; Quick Set Up</h3>
                                            <div className="desc">
                                                Augue sit amet ex sodales finibus a at odio. Aenean
                                                vulputate ligula.
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-12">
                                <div className="icon-box">
                                    <div className="inner">
                                        ...
                                        <div className="content pdr50">
                                            <h3 className="title">Pre-Made Templates</h3>
                                            <div className="desc">
                                                Vestibulum vitae augue sit amet ex sodales finibus a at
                                                odio.
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-12">
                                <div className="icon-box">
                                    <div className="inner">
                                        ...
                                        <div className="content pdr50">
                                            <h3 className="title">Multiple Upsell Funnels</h3>
                                            <div className="desc">
                                                Sit amet ex sodales finibus a at odio aenean vulputate
                                                ligula.
                                            </div>
                                        </div>
                                    </div>
