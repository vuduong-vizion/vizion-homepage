...
export default function GetInTouch() {
    ...
    return (
        <>
            <section className="section background-full background-overlay bo4" style={{ backgroundImage: 'url(/assets/images/vizion/others/closeup-business-woman-hand-typing-laptop-keyboard-with-m.jpg)' }}>
