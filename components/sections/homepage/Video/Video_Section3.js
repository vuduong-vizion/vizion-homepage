...
export default function Video_Section3() {
                        ...
                        <div className="col-lg-6">
                            <div className="pdr100">
                                <div className="images layout-02 lg-mb60">
                                    <div className="inner">
                                        <img className="img01" src="/assets/images/hv-06.png" alt="Image" />
                                        <img className="img19 wow animate__animated animate__fadeInRight" src="/assets/images/post-author-01.jpg" alt="Image" />
                                        <img className="img20 wow animate__animated animate__fadeInRight" src="/assets/images/post-author-02.jpg" alt="Image" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="pdl60 pdr100">
                                <div className="heading mb24">
                                    ...
                                    <h2 className="heading-title">Meet from anywhere.</h2>
