...
export default function Rtl_Section8() {
    return (
        <>
            <section className="section-banner background-navy layout-04">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-1">
                                <div className="banner-right layout-02 lg-hidden">
                                    <img className="wow animate__animated animate__fadeInRight" src="/assets/images/hr-15.png" alt="Banner" />
                                </div>
                            </div>
                        </div>
                    </div>
