...
export default function PorfolioMinimalMosaic() {
    return (
        <>
            <Layout pageTitle="Minimal  Mosaic" pageTitleDesc="Take a look at our recent projects">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="portfolio-middle portfolio-isotope">
                            <PortfolioFilterOne portfolioStyle="mosaic style-minimal" />
                            </div>
