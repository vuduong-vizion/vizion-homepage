...
export default function PorfolioClassicMetro() {
    return (
        <>
            <Layout pageTitle="Classic Metro" pageTitleDesc="Take a look at our recent projects">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="portfolio-middle portfolio-isotope">
                                <PortfolioFilterOne portfolioStyle="metro"/>
                            </div>
