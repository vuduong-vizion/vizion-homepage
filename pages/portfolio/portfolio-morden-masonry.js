...
export default function PorfolioModernMasonary() {
    return (
        <>
            <Layout pageTitle="Modern  Masonary" pageTitleDesc="Take a look at our recent projects">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="portfolio-middle portfolio-isotope">
                                <PortfolioFilterOne portfolioStyle="masonary style-modern" />
                            </div>
