...
export default function PorfolioClassicMosaic() {
    return (
        <>
            <Layout pageTitle="Classic Mosaic" pageTitleDesc="Take a look at our recent projects">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="portfolio-middle portfolio-isotope">
                                <PortfolioFilterOne portfolioStyle="mosaic" />
                            </div>
