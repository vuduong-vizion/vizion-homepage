...
export default function BlogBoxedList() {
    return (
        <>
            <Layout pageTitle="List  Layout" pageTitleDesc="Share your stories and news with everyone.">
                    ...
                    <div className="row">
                        <div className="col-lg-9 col-auto">
                            <div className="blog-middle">
                                ...
                                <article className="post post-list format-video post-featured style-boxed">
                                ...
                                <article className="post post-list format-gallery style-boxed">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-video style-boxed">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-quote style-boxed">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-link style-boxed">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-audio style-boxed">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list style-boxed">
                                    <div className="entry-thumbnail">
