...
export default function BlogSimpleList() {
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-lg-9 col-auto">
                            <div className="blog-middle">
                                ...
                                <article className="post post-list format-video post-featured">
                                ...
                                <article className="post post-list format-gallery">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-video">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-quote">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-link">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-audio">
                                    <div className="entry-thumbnail">
