...
export default function BlogBgList() {
    return (
        <>
            <Layout
                pageTitle="List  Layout"
                    ...
                    <div className="row">
                        <div className="col-lg-9 col-auto">
                            <div className="blog-middle">
                                ...
                                <article className="post post-list format-video post-featured style-bg">
                                ...
                                <article className="post post-list format-gallery style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-video style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-quote style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-link style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list format-audio style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post post-list style-bg">
                                    <div className="entry-thumbnail">
