...
export default function BlogBgStandard() {
    return (
        <>
            <Layout
                pageTitle="Standard Layout"
                    ...
                    <div className="row">
                        <div className="col-lg-9 col-auto">
                            <div className="blog-middle">
                                ...
                                <article className="post format-video post-featured style-bg">
                                ...
                                <article className="post format-gallery style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post format-video style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post format-quote style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post format-link style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post format-audio style-bg">
                                    <div className="entry-thumbnail">
                                ...
                                <article className="post style-bg">
                                    <div className="entry-thumbnail">
