...
export default function BlogBoxedGrid() {
    return (
        <>
            <Layout pageTitle="Grid  Layout" pageTitleDesc="Share your stories and news with everyone.">
                            ...
                            <div className="blog-middle">
                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-video post-featured style-boxed">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-gallery style-boxed">
                                            <div className="entry-thumbnail">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-video style-boxed">
                                            <div className="entry-thumbnail">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-quote style-boxed">
                                            <div className="entry-thumbnail">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-link style-boxed">
                                            <div className="entry-thumbnail">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-audio style-boxed">
                                            <div className="entry-thumbnail">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid style-boxed">
                                            <div className="entry-thumbnail">
