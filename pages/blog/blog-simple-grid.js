...
export default function BlogSimpleGrid() {
    return (
        <>
                        ...
                        <div className="col-lg-12">
                            <div className="blog-middle">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-quote">
                                            <div className="entry-thumbnail">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-link">
                                            <div className="entry-thumbnail">
                                    ...
                                    <div className="col-lg-4 col-sm-6 col-12">
                                        <article className="post post-grid format-audio">
                                            <div className="entry-thumbnail">
