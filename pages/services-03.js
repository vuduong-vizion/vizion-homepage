                        ...
                        <div className="row flex-align-c h100">
                            <div className="col-lg-6">
                                <div className="heading mg0 pdr80">
                                    ...
                                    <h2 className="heading-title size-xl">Built for all company sizes</h2>
                                    <div className="heading-desc">Lorem ipsum dolor sit amet consectetur adipisc elit viverra dignissim pellentesque in acolmine.</div>
                            ...
                            <div className="col-lg-6">
                                <div className="lg-mt32 align-center">
                                    <img src="/assets/images/services-09.svg" alt="Banner" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="section spdt">
                    <div className="container">
                        <div className="heading align-center">
                            <div className="heading-sub">Services</div>
                                ...
                                <div className="col-lg-6">
                                    <div className="content lg-mt32 pdl50">
                                        <div className="heading mb32">
                                            <div className="heading-sub">Insight</div>
